...
export default function SettingsScreen({ onLogout }: SettingsScreenProps) {
    ...
    return (
        <View className="flex-1 bg-zinc-50">
            <View className="bg-white border-b border-zinc-200 p-4">
                <Text className="text-lg font-bold text-zinc-900">Cài Đặt & Dữ Liệu</Text>
            </View>
            ...
            <ScrollView className="p-4 space-y-4">
                ...
                <View className="items-center mt-8">
                    <Text className="text-xs text-zinc-300">QLK Mobile v1.0.0</Text>
                </View>
            </ScrollView>
        </View>
    );
